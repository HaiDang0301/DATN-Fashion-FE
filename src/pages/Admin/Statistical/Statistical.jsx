            ...
            <div className="col-lg-3">
              <div className={cx("annual-revenue")}>
                <div className={cx("content")}>
                  ...
                  <div className={cx("annual-money")}>{Number(money).toLocaleString()}</div>
                </div>
              </div>
            </div>
            <div className="col-lg-3">
              ...
              <div className={cx("total-sale")}>
                <div className={cx("content")}>
                  ...
                  <div className={cx("sales-money")}>
                    {Number(data.findMonth[0].sales_Money).toLocaleString()}
                  </div>
                </div>
              </div>
            </div>
              ...
              {data
                ? data.paginateData.data.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td>{item.sizes.map((quantity, index) => (
                          <li key={index}>{Number(quantity.quantity*Number(item.price)).toLocaleString()}</li>
                        ))}</td>
